...
public class TableEditorMainFrame {
    ...
    final public static int CHANGE_SERVER_BUTTON_INDEX = 5;

    private JFrame mainFrame;
    private JToolBar toolBar;
    private JLabel lostConnectionIcon;
    ...
    public TableEditorMainFrame() {
        toolPanelButtons = new ArrayList<JButton>();
    ...
    private void addMenuBar(){
        ...
        menuItem = new JMenuItem("Сменить сервер");
        menu.add(menuItem);
        menuButtons.add(menuItem);
    ...
    private void addToolPanel() {
        ...
        lostConnectionIcon = new JLabel(new ImageIcon("img/warning.png"));
        toolBar.add(lostConnectionIcon);
        mainFrame.add(toolBar, BorderLayout.NORTH);

    }

    public void lostConnectionIcon(boolean isVisible){
        lostConnectionIcon.setVisible(isVisible);
        toolBar.repaint();
    }
