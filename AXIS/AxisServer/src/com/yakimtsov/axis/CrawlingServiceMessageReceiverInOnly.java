/**
 * CrawlingServiceMessageReceiverInOnly.java
 *
...
/**
 *  CrawlingServiceMessageReceiverInOnly message receiver
 */
public class CrawlingServiceMessageReceiverInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver {
    public void invokeBusinessLogic(
        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("modifyArticle".equals(methodName)) {
                    //doc style
                    com.yakimtsov.axis.service.ModifyArticle wrappedParam = (com.yakimtsov.axis.service.ModifyArticle) fromOM(msgContext.getEnvelope()
                                                                                                                                        .getBody()
                                                                                                                                        .getFirstElement(),
                            com.yakimtsov.axis.service.ModifyArticle.class);

                    skel.modifyArticle(wrappedParam);

                    envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                } else if ("addArticle".equals(methodName)) {
                    //doc style
                    com.yakimtsov.axis.service.AddArticle wrappedParam = (com.yakimtsov.axis.service.AddArticle) fromOM(msgContext.getEnvelope()
                                                                                                                                  .getBody()
                                                                                                                                  .getFirstElement(),
                            com.yakimtsov.axis.service.AddArticle.class);

                    skel.addArticle(wrappedParam);

                    envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                } else if ("deleteArticle".equals(methodName)) {
                    //doc style
                    com.yakimtsov.axis.service.DeleteArticle wrappedParam = (com.yakimtsov.axis.service.DeleteArticle) fromOM(msgContext.getEnvelope()
                                                                                                                                        .getBody()
                                                                                                                                        .getFirstElement(),
                            com.yakimtsov.axis.service.DeleteArticle.class);
