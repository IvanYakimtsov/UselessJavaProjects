...
public class Author implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Author
       Namespace URI = http://service.axis.yakimtsov.com/xsd
     ...
     */
    protected java.lang.String localExperience;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localExperienceTracker = false;
    ...
    public boolean isExperienceSpecified() {
        return localExperienceTracker;
    }
     ...
     */
    public void setExperience(java.lang.String param) {
        localExperienceTracker = true;

        this.localExperience = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter,
                    "http://service.axis.yakimtsov.com/xsd");
        ...
        if (localExperienceTracker) {
            namespace = "http://service.axis.yakimtsov.com/xsd";
            writeStartElement(null, namespace, "experience", xmlWriter);
            ...
            if (localExperience == null) {
                ...
                xmlWriter.writeCharacters(localExperience);
            }
    ...
    private static java.lang.String generatePrefix(java.lang.String namespace) {
        if (namespace.equals("http://service.axis.yakimtsov.com/xsd")) {
            return "ns1";
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Author".equals(type)) {
                            ...
                            return (Author) com.yakimtsov.axis.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://service.axis.yakimtsov.com/xsd",
                            "experience").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setExperience(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://service.axis.yakimtsov.com/xsd", "name").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://service.axis.yakimtsov.com/xsd", "surname").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
